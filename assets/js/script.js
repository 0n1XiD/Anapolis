...
$(window).scroll(function () {
    ...
    if ($('.communicHasClass').hasClass('communications__main')){
        ...
        if ($communicTop + $communicAnim.height() / 4 < docViewBottom && docViewBottom  < $communicBottom + $communicAnim.height() / 4 ) {
...
$(document).ready(function() {
    $('.design__slider:not(.room1)').hide();

    $('.click-reviews').on('click', function() {
        var catalogValue = $(this).data('catalog');
