...
let construct1Swiper = new Swiper(".construct1__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct1-swiper-next",
        prevEl: ".construct1-swiper-prev",
    },
});


let construct2Swiper = new Swiper(".construct2__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct2-swiper-next",
        prevEl: ".construct2-swiper-prev",
    },
});


let construct3Swiper = new Swiper(".construct3__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct3-swiper-next",
        prevEl: ".construct3-swiper-prev",
    },
});

let construct4Swiper = new Swiper(".construct4__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct4-swiper-next",
        prevEl: ".construct4-swiper-prev",
    },
});

let construct5Swiper = new Swiper(".construct5__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct5-swiper-next",
        prevEl: ".construct5-swiper-prev",
    },
});

let construct6Swiper = new Swiper(".construct6__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct6-swiper-next",
        prevEl: ".construct6-swiper-prev",
    },
});

let construct7Swiper = new Swiper(".construct7__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct7-swiper-next",
        prevEl: ".construct7-swiper-prev",
    },
});

let construct8Swiper = new Swiper(".construct8__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct8-swiper-next",
        prevEl: ".construct8-swiper-prev",
    },
});

let construct9Swiper = new Swiper(".construct9__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct9-swiper-next",
        prevEl: ".construct9-swiper-prev",
    },
});

let construct10Swiper = new Swiper(".construct10__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct10-swiper-next",
        prevEl: ".construct10-swiper-prev",
    },
});

let construct11Swiper = new Swiper(".construct11__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct11-swiper-next",
        prevEl: ".construct11-swiper-prev",
    },
});

let construct12Swiper = new Swiper(".construct12__slider", {
    slidesPerView: 1,
    spaceBetween: 5,
    loop: true,
    pagination: {
    ...
    navigation: {
        nextEl: ".construct12-swiper-next",
        prevEl: ".construct12-swiper-prev",
    },
});
...
var pfree =  $('[data-free]');
var scrollApartment =  $('.scroll-apartment');
var activePlansDataset = {}

pfree.on('mouseenter', function(e) {
    activePlansDataset = e.currentTarget.dataset
    var apartQueue = $('.apart-queue__cnt');
    var plansInfo = $('.plans-free');
    var mainPlan = $('.main-plan-js');

    // Получаем размеры блока .plans-free
    var plansWidth = plansInfo.outerWidth();
    var plansHeight = plansInfo.outerHeight();

    // Границы, в пределах которых можно разместить .plans-free
    var maxX = mainPlan.outerWidth() - plansWidth;
    var maxY = mainPlan.outerHeight() - plansHeight;

    var y = e.pageY - mainPlan.offset().top;
    var x = e.pageX - mainPlan.offset().left;

    // Проверяем, чтобы .plans-free не выходил за границы блока main-plan-js
    if (x + plansWidth > mainPlan.outerWidth()) {
        x = mainPlan.outerWidth() - plansWidth;
    }
    ...
    if (y + plansHeight + 20 > mainPlan.outerHeight()) {
        y = mainPlan.outerHeight() - (plansHeight + 20);
    }

    // Проверяем, чтобы .plans-free не выходил за границы экрана
    if (y > maxY) {
        y = maxY;
    }
    ...
    if (
        x - plansWidth - 20 < apartQueue[0].offsetLeft + apartQueue[0].offsetWidth + scrollApartment[0].scrollLeft &&
        y + plansHeight > mainPlan.outerHeight() - apartQueue[0].offsetHeight
    ) {
...
scrollApartment.on('mousemove', function(e) {
    var targetElement = $(e.target);
    if (
        targetElement[0].nodeName !== 'path' &&
